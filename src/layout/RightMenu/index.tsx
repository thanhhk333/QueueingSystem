...
import { IconBack, IconImport } from '@assets/icon';
...
const listIconType = {
  ...
  import: <IconImport />,
  export: <Icon.Save size="24" className="icon-feather" />,
};
...
const RenderItem = React.memo(({ item }: { item: IArrayAction }) => {
  ...
  return (
    <Tooltip placement="left" title={title} overlayStyle={{ width: 'fit-content' }}>
