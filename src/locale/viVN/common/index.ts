export default {
  ...
  'common.yes': 'Có',
  'common.no': 'Không',
  'common.choose-file': 'Chọn file',
  'common.recall': 'Thu hồi',
  'common.import': 'Nhập file',
  'common.normal': 'Thường',
  'common.prioritize': 'Ưu tiên',
  'common.upload.title': 'Kéo thả hoặc chọn file',
  'common.upload.content.one': 'Chỉ thêm được 1 file',
  'common.ok': 'Xác nhận',
  'common.lengthMax255': 'Độ dài vượt quá 255 kí tự',
  'common.import-voucher': 'Quản lý nhập voucher',
  'common.print': 'Xuất danh sách',
  'common.week': 'Tuần',
  'common.to': 'đến',
};
